...
if __name__ == '__main__':
    ...
    producto_agregado = producto.add_producto('123', 'Remera', 'M', 'url_de_la_foto', 'Rojo')
    print(f'Producto agregado: {producto_agregado}')

    # Ejemplo: Obtener un producto
    producto_obtenido = producto.get_producto('123')
    ...
    producto_actualizado = producto.update_producto('123', 'Remera', 'L', 'url_de_la_foto', 'Azul')
    print(f'Producto actualizado: {producto_actualizado}')

    
    
    # Ejemplo: Agregar una tienda
    tienda_agregada = tienda.add_tienda( '001','Calle Falsa 123', 'Ciudad Ejemplo', 'Provincia Ejemplo', True)
    ...
    nuevo_stock = stock.add_stock(tienda='001', producto_codigo='123', cantidad=10)
    ...
    stock_actualizado = stock.update_stock(id=nuevo_stock.id, tienda='001', producto_codigo='123', cantidad=20)
